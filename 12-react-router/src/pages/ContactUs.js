...
export default function ContactUs() {
    ...
    const updateFormField = (e) => {
        // e.target.name will be either 'name', 'email' or 'comments'
    ...
    return (
        <React.Fragment>
            ...
            <div>
                <label>Name:</label>
                <input type="text" name="name" value={formState.name} onChange={updateFormField}/>
            </div>
            <div>
                <label>Email:</label>
            ...
            <div>
                ...
                <textarea name="comments" onChange={updateFormField} value={formState.comments}></textarea>
            </div>
